...
namespace IAPWS.IF97
{
    public class UEWater
    {
        ...
        [DllImport("UEwasp.dll", EntryPoint = "PT2S", CharSet = CharSet.Ansi, ExactSpelling = false, SetLastError = true, CallingConvention = CallingConvention.StdCall)]
